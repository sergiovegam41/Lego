...
if (!class_exists('Components\Shared\Forms\Forms\Form') && class_exists(\Components\Shared\Forms\FormComponent\FormComponent::class)) {
    class_alias(\Components\Shared\Forms\FormComponent\FormComponent::class, 'Components\Shared\Forms\Forms\Form');
}
if (!class_exists('Components\Shared\Forms\Forms\FormGroup') && class_exists(\Components\Shared\Forms\FormGroupComponent\FormGroupComponent::class)) {
    class_alias(\Components\Shared\Forms\FormGroupComponent\FormGroupComponent::class, 'Components\Shared\Forms\Forms\FormGroup');
}
if (!class_exists('Components\Shared\Forms\Forms\FormActions') && class_exists(\Components\Shared\Forms\FormActionsComponent\FormActionsComponent::class)) {
...
if (!class_exists('Components\Shared\Forms\Forms\FormRow') && class_exists(\Components\Shared\Forms\FormRowComponent\FormRowComponent::class)) {
    class_alias(\Components\Shared\Forms\FormRowComponent\FormRowComponent::class, 'Components\Shared\Forms\Forms\FormRow');
}
if (!class_exists('Components\Shared\Forms\Forms\InputText') && class_exists(\Components\Shared\Forms\InputTextComponent\InputTextComponent::class)) {
    class_alias(\Components\Shared\Forms\InputTextComponent\InputTextComponent::class, 'Components\Shared\Forms\Forms\InputText');
}
if (!class_exists('Components\Shared\Forms\Forms\TextArea') && class_exists(\Components\Shared\Forms\TextAreaComponent\TextAreaComponent::class)) {
    class_alias(\Components\Shared\Forms\TextAreaComponent\TextAreaComponent::class, 'Components\Shared\Forms\Forms\TextArea');
}
if (!class_exists('Components\Shared\Forms\Forms\Select') && class_exists(\Components\Shared\Forms\SelectComponent\SelectComponent::class)) {
    class_alias(\Components\Shared\Forms\SelectComponent\SelectComponent::class, 'Components\Shared\Forms\Forms\Select');
}
if (!class_exists('Components\Shared\Forms\Forms\Checkbox') && class_exists(\Components\Shared\Forms\CheckboxComponent\CheckboxComponent::class)) {
    class_alias(\Components\Shared\Forms\CheckboxComponent\CheckboxComponent::class, 'Components\Shared\Forms\Forms\Checkbox');
}
if (!class_exists('Components\Shared\Forms\Forms\Radio') && class_exists(\Components\Shared\Forms\RadioComponent\RadioComponent::class)) {
    class_alias(\Components\Shared\Forms\RadioComponent\RadioComponent::class, 'Components\Shared\Forms\Forms\Radio');
}
if (!class_exists('Components\Shared\Forms\Forms\Button') && class_exists(\Components\Shared\Forms\ButtonComponent\ButtonComponent::class)) {

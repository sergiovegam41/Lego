...
function drawPieChart(chartData) {
    ...
    window.managersChartData = chartData;
    window.managersChart = chart;
    ...
    const observer = new MutationObserver((mutations) => {
        mutations.forEach((mutation) => {
            if (mutation.attributeName === 'class') {
                console.log('[Managers] Tema cambiado, redibujando gráfico...');
                // Redibujar el gráfico con los nuevos colores
                if (window.managersChartData && window.managersChart) {
                    drawPieChart(window.managersChartData);
                }
            }
        });
    });
